...
public class ProductControllerTest {
	...
	public void getProductInfoTest() throws Exception {
		...
		Product mockProduct = new Product("13860428", "The Big Lebowski (Blu-ray) (Widescreen)", currency);
		...
		// Expected Result
		String expectedProductJson = "{\"productId\": \"13860428\",\"title\": \"The Big Lebowski (Blu-ray) (Widescreen)\",\"current_price\": {\"value\": \"13.59\",\"currency_code\": \"USD\"}}";
